...
class SelectFromTreeFortschreibungContainer extends TTemplateControl {
    ...
    public function initParameters(){
        $this->SFTauf_tabelle->Text = $this->page->FortschreibungContainer->SFTauf_tabelle->Text;
        $this->SFTstart_id->Text = $this->page->FortschreibungContainer->SFTstart_id->Text;
    }
    ...
    public function ChooseLevel($sender,$param){
        $this->page->FortschreibungContainer->{$this->SFTauf_tabelle->Text}->Text =$sender->CommandParameter;
    }
