...
class PDF_001_Protokoll_Standard extends TPage {
   ...
   private function LetterContent($idtm_protokoll){
        ...
        $SQL .= " ORDER BY idtm_protokoll_detail_group DESC, idtm_protokoll_detail DESC";
        ...
        foreach($ProtokollDetails AS $ProtokollDetail){
            ...
            $this->pdf->Cell(15,6,$ProtokollDetail->idtm_protokoll_detail_group . ' ' .$ProtokollDetail->idtm_protokoll_detail,1,0,'C',1);
            $this->pdf->SetFillColor(255,255,255);
            $this->pdf->SetDrawColor(234,242,220);
            $this->pdf->Cell(170,6,utf8_decode($ProtokollDetail->prtdet_topic),1,0,'',1);
            $this->pdf->Ln(8);
            //$this->pdf->SetX(28);
            $this->pdf->SetFillColor(255,255,255);
            ...
            if($ProtokollDetail->idta_protokoll_ergebnistype < 3){
                ...
                $this->pdf->Cell(185,5,'Auftrag',1,0,'',1);
                $this->pdf->Ln();
                //$this->pdf->SetX(20);
                $this->pdf->SetFillColor(255,255,255);
                $this->pdf->SetFont('Arial','',9);
                $this->pdf->MultiCell(185,6,utf8_decode($ProtokollDetail->auf_beschreibung),1,'L',0);
                $this->pdf->Cell(125,5,'Wer',1,0,'',1);
                $this->pdf->Cell(30,5,'Bis',1,0,'',1);
                $this->pdf->Cell(30,5,'Erledigt',1,0,'',1);
                $this->pdf->Ln();                                
                $this->pdf->Cell(125,6,utf8_decode(OrganisationRecord::finder()->findByPk($ProtokollDetail->idtm_organisation)->org_name),1,'');
