...
/** PHPExcel_RichText */
require_once dirname(__FILE__).'/../../RichText.php';

require_once dirname(__FILE__).'/../../Shared/String.php';

/** PHPExcel_Shared_Excel5 */
require_once dirname(__FILE__).'/../../Shared/Excel5.php';

/** PHPExcel_Shared_Escher */
require_once dirname(__FILE__).'/../../Shared/Escher.php';

/** PHPExcel_Shared_Escher_DgContainer */
require_once dirname(__FILE__).'/../../Shared/Escher/DgContainer.php';

/** PHPExcel_Shared_Escher_DgContainer_SpgrContainer */
require_once dirname(__FILE__).'/../../Shared/Escher/DgContainer/SpgrContainer.php';

/** PHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer */
require_once dirname(__FILE__).'/../../Shared/Escher/DgContainer/SpgrContainer/SpContainer.php';
