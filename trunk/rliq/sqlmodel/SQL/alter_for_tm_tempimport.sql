...
CREATE  TABLE IF NOT EXISTS `harley2009`.`tm_tempimport` (
  `idtm_tempimport` INT(11) NULL DEFAULT NULL AUTO_INCREMENT ,
  `ti_name` VARCHAR(45) NULL DEFAULT NULL ,
  `user_name` VARCHAR(45) NULL DEFAULT NULL ,
  `ti_id1` VARCHAR(45) NULL DEFAULT NULL ,
  `ti_id2` VARCHAR(45) NULL DEFAULT NULL ,
  `ti_id3` VARCHAR(45) NULL DEFAULT NULL ,
  `ti_id4` VARCHAR(45) NULL DEFAULT NULL ,
  `ti_id5` VARCHAR(45) NULL DEFAULT NULL ,
  `ti_id6` VARCHAR(45) NULL DEFAULT NULL ,
  `ti_id7` VARCHAR(45) NULL DEFAULT NULL ,
  `ti_id8` VARCHAR(45) NULL DEFAULT NULL ,
  `ti_id9` VARCHAR(45) NULL DEFAULT NULL ,
  `ti_id10` VARCHAR(45) NULL DEFAULT NULL ,
  `ti_label1` VARCHAR(90) NULL DEFAULT NULL ,
  `ti_label2` VARCHAR(90) NULL DEFAULT NULL ,
  `ti_label3` VARCHAR(90) NULL DEFAULT NULL ,
  `ti_label4` VARCHAR(90) NULL DEFAULT NULL ,
  `ti_label5` VARCHAR(90) NULL DEFAULT NULL ,
  `ti_label6` VARCHAR(90) NULL DEFAULT NULL ,
  `ti_label7` VARCHAR(90) NULL DEFAULT NULL ,
  `ti_label8` VARCHAR(90) NULL DEFAULT NULL ,
  `ti_label9` VARCHAR(90) NULL DEFAULT NULL ,
  `ti_label10` VARCHAR(90) NULL DEFAULT NULL ,
  `ti_value1` FLOAT NULL DEFAULT NULL ,
  `ti_value2` FLOAT NULL DEFAULT NULL ,
  `ti_value3` FLOAT NULL DEFAULT NULL ,
  `ti_value4` INT(11) NULL DEFAULT NULL ,
  `per_intern` BIGINT(20) NULL DEFAULT NULL ,
