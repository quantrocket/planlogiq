...
//	$this->pdf->Cell(120);
	//Logo
        $this->pdf->image('../rliq/themes/basic/gfx/logo_hpartner.png',120,8,76);
	//Move to the right
	//Line break
        $this->pdf->SetXY(120, 20);
        $this->pdf->SetTextColor(43,51,43);
        $this->pdf->SetFont('Helvetica','',8);
        $this->pdf->Cell(60,4,'HARRER UNTERNEHMENSBERATUNG KG',0,0,'',0);
        $this->pdf->Ln();$this->pdf->SetX(120);
        $this->pdf->Cell(60,4,'Kollergasse 6/1 | 1030 Wien',0,0,'',0);
        $this->pdf->Ln();$this->pdf->SetX(120);
        $this->pdf->Cell(60,4,'T: +43-(0)1-890 1529 0 | F: +43-(0)1-890 1529-20',0,0,'',0);
        $this->pdf->Ln();$this->pdf->SetX(120);
        $this->pdf->Cell(60,4,'www.hpartner.at',0,0,'',0);
    }
