...
class StrukturBerichtViewer extends TPage {
...
//            $RolandTicket = $QVTestSecure->getTicketHTMLSQL($this->User->Name);
    ...
    private function generateGraph($MyArray,$ObjID) {
        ...
        return $this->getRequest()->constructUrl('page','graph', 3, array( 'height' => $height, 'legend' => $legend, 'title' => $title,'width' => $width,'xdata' => $xdata, 'ydata1' => $ydata1, 'ytitle' => $ytitledata), false);
    }
