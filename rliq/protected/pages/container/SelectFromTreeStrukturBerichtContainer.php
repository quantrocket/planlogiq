...
class SelectFromTreeStrukturBerichtContainer extends TTemplateControl {
    ...
    public function initParameters(){
        $this->SFTauf_tabelle->Text = $this->page->StrukturBerichtContainer->SFTauf_tabelle->Text;
        $this->SFTstart_id->Text = $this->page->StrukturBerichtContainer->SFTstart_id->Text;
    }
    ...
    public function ChooseLevel($sender,$param){
        $this->page->StrukturBerichtContainer->{$this->SFTauf_tabelle->Text}->Text =$sender->CommandParameter;
    }
