...
class PFDHTMLXTreeOrganisationLayout extends TWebControl {
...
<script type="text/javascript" charset="UTF-8">
    ...
    //function doOnLoad() {
        ...
        dhxLayout.cells("a").setHeight(113);
        dhxLayout.cells("a").attachObject("orgheader");
        ...
        dhxLayout.cells("b").setWidth(280);
        dhxLayout.cells("b").setText("Organisationen");
        ...
        dhxTabbar.addTab("a1","Verlauf","100px");
        dhxTabbar.setContent("a1", "tabhtml_1");
        dhxTabbar.addTab("a2","Informationen","100px");
        dhxTabbar.setContent("a2", "tabhtml_2");

        dhxTabbar.addTab("a3","Rechnungen","100px");
        dhxTabbar.setContent("a3", "tabhtml_3");

        dhxTabbar.addTab("a4","Ansprechpartner","100px");
        dhxTabbar.setContent("a4", "tabhtml_4");
