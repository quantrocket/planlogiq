...
include_once('linearBestFitClass.php');
include_once('logarithmicBestFitClass.php');
include_once('exponentialBestFitClass.php');
include_once('powerBestFitClass.php');
include_once('polynomialBestFitClass.php');
