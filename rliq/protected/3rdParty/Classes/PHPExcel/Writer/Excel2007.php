...
/** PHPExcel_IWriter */
require_once dirname(__FILE__).'/../Writer/IWriter.php';

/** PHPExcel_Shared_XMLWriter */
require_once dirname(__FILE__).'/../Shared/XMLWriter.php';

/** PHPExcel_Writer_Excel2007_WriterPart */
require_once dirname(__FILE__).'/../Writer/Excel2007/WriterPart.php';

/** PHPExcel_Writer_Excel2007_StringTable */
require_once dirname(__FILE__).'/../Writer/Excel2007/StringTable.php';

/** PHPExcel_Writer_Excel2007_ContentTypes */
require_once dirname(__FILE__).'/../Writer/Excel2007/ContentTypes.php';

/** PHPExcel_Writer_Excel2007_DocProps */
require_once dirname(__FILE__).'/../Writer/Excel2007/DocProps.php';

/** PHPExcel_Writer_Excel2007_Rels */
require_once dirname(__FILE__).'/../Writer/Excel2007/Rels.php';

/** PHPExcel_Writer_Excel2007_Theme */
require_once dirname(__FILE__).'/../Writer/Excel2007/Theme.php';

/** PHPExcel_Writer_Excel2007_Style */
require_once dirname(__FILE__).'/../Writer/Excel2007/Style.php';

/** PHPExcel_Writer_Excel2007_Workbook */
require_once dirname(__FILE__).'/../Writer/Excel2007/Workbook.php';

/** PHPExcel_Writer_Excel2007_Worksheet */
require_once dirname(__FILE__).'/../Writer/Excel2007/Worksheet.php';

/** PHPExcel_Writer_Excel2007_Drawing */
require_once dirname(__FILE__).'/../Writer/Excel2007/Drawing.php';

/** PHPExcel_Writer_Excel2007_Comments */
require_once dirname(__FILE__).'/../Writer/Excel2007/Comments.php';
