...
require_once dirname(__FILE__).'/../../Writer/Excel2007.php';
...
require_once dirname(__FILE__).'/../../Style/Borders.php';

/** PHPExcel_Style_Border */
require_once dirname(__FILE__).'/../../Style/Border.php';

/** PHPExcel_Style_Color */
require_once dirname(__FILE__).'/../../Style/Color.php';

/** PHPExcel_Style_Fill */
require_once dirname(__FILE__).'/../../Style/Fill.php';

/** PHPExcel_Style_Font */
require_once dirname(__FILE__).'/../../Style/Font.php';

/** PHPExcel_Style_NumberFormat */
require_once dirname(__FILE__).'/../../Style/NumberFormat.php';

/** PHPExcel_Style_Conditional */
require_once dirname(__FILE__).'/../../Style/Conditional.php';

/** PHPExcel_Style_Protection */
require_once dirname(__FILE__).'/../../Style/Protection.php';
