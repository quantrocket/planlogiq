...
require_once dirname(__FILE__).'/../../Shared/Date.php';

/** PHPExcel_Shared_String */
require_once dirname(__FILE__).'/../../Shared/String.php';

/** PHPExcel_Shared_Escher */
require_once dirname(__FILE__).'/../../Shared/Escher.php';

/** PHPExcel_Shared_Escher_DggContainer */
require_once dirname(__FILE__).'/../../Shared/Escher/DggContainer.php';

/** PHPExcel_Shared_Escher_DggContainer_BstoreContainer */
require_once dirname(__FILE__).'/../../Shared/Escher/DggContainer/BstoreContainer.php';

/** PHPExcel_Shared_Escher_DggContainer_BstoreContainer_BSE */
require_once dirname(__FILE__).'/../../Shared/Escher/DggContainer/BstoreContainer/BSE.php';

/** PHPExcel_Shared_Escher_DggContainer_BstoreContainer_BSE_Blip */
require_once dirname(__FILE__).'/../../Shared/Escher/DggContainer/BstoreContainer/BSE/Blip.php';

/** PHPExcel_Shared_OLE_PPS_Root */
require_once dirname(__FILE__).'/../../Shared/OLE/OLE_Root.php';

/** PHPExcel_Shared_OLE_PPS_File */
require_once dirname(__FILE__).'/../../Shared/OLE/OLE_File.php';

/** PHPExcel_Writer_Excel5_Xf */
require_once dirname(__FILE__).'/../../Writer/Excel5/Xf.php';

/** PHPExcel_Writer_Excel5_BIFFwriter */
require_once dirname(__FILE__).'/../../Writer/Excel5/BIFFwriter.php';

/** PHPExcel_Writer_Excel5_Worksheet */
require_once dirname(__FILE__).'/../../Writer/Excel5/Worksheet.php';

/** PHPExcel_Writer_Excel5_Font */
require_once dirname(__FILE__).'/../../Writer/Excel5/Font.php';

/** PHPExcel_Writer_Excel5_Parser */
require_once dirname(__FILE__).'/../../Writer/Excel5/Parser.php';

/** PHPExcel_Writer_Excel5_Escher */
require_once dirname(__FILE__).'/../../Writer/Excel5/Escher.php';
